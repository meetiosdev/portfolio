...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="
        default-src 'self';
        script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://www.clarity.ms https://www.googletagmanager.com https://www.google-analytics.com https://cdn.jsdelivr.net https://itunes.apple.com;
        connect-src 'self' https://www.clarity.ms https://liffowvslpcykrktlved.supabase.co https://www.google-analytics.com https://region1.google-analytics.com https://analytics.google.com;
        img-src 'self' data: https://www.clarity.ms https://www.google-analytics.com https://is1-ssl.mzstatic.com;
